...
class Resizer {
    constructor(vertical = false, minDistance) {
        ...
        this.el = (0, element_1.h)('div', `${config_1.cssPrefix}-resizer ${vertical ? 'vertical' : 'horizontal'}`).children(this.unhideHoverEl = (0, element_1.h)('div', `${config_1.cssPrefix}-resizer-hover`)
            .on('dblclick.stop', evt => this.mousedblclickHandler(evt))
            .css('position', 'absolute').hide(), this.hoverEl = (0, element_1.h)('div', `${config_1.cssPrefix}-resizer-hover`)
            .on('mousedown.stop', evt => this.mousedownHandler(evt)), this.lineEl = (0, element_1.h)('div', `${config_1.cssPrefix}-resizer-line`).hide()).hide();
        // cell rect
        this.cRect = null;
