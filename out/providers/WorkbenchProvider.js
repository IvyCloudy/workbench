...
class WorkbenchProvider {
    ...
    show() {
        ...
        this.panel = vscode.window.createWebviewPanel('workbench', '工作台', vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    getHtmlContent() {
        ...
        try {
            ...
            html = html.replace(/\$\{scriptUri\}/g, this.panel.webview.asWebviewUri(vscode.Uri.joinPath(this.extensionUri, 'media', 'pages', 'workbench', 'main.js')).toString());
            return html;
        }
        catch {
