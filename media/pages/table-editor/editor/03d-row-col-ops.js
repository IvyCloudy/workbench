/* =============================================================================
 * 03d-row-col-ops.js  —— 行/列数据操作（增删/复制/粘贴/清空 等）
 * -----------------------------------------------------------------------------
 * 由原 03a-cell-edit.js 拆分而来，集中所有"写操作"工具函数：
 *   _inferDetailColKind / _readDetailCellRaw / _writeDetailCellFromRaw /
 *   _filePushedBefore / insertRow / deleteRow / deleteSelectedRows /
 *   insertCol / deleteCol / renameCol / copyCell / pasteCell / clearCell /
 *   fillSelectedCells / copyRow / copyRowInline / copySelectedRows /
 *   pushFromContextMenu
 *
