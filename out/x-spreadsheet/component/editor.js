...
class Editor {
    constructor(formulas, viewFn, rowHeight) {
        ...
        this.suggest = new suggest_1.default(formulas, (it) => {
            suggestItemClick.call(this, it);
        });
        this.datepicker = new datepicker_1.default();
        this.datepicker.change((d) => {
            // console.log('d:', d);
            this.setText(dateFormat(d));
            this.clear();
        });
        this.areaEl = (0, element_1.h)('div', `${config_1.cssPrefix}-editor-area`)
            .children(this.textEl = (0, element_1.h)('textarea', '')
            .on('input', evt => inputEventHandler.call(this, evt))
            .on('paste.stop', () => { })
            .on('keydown', evt => keydownEventHandler.call(this, evt)), this.textlineEl = (0, element_1.h)('div', 'textline'), this.suggest.el, this.datepicker.el)
            .on('mousemove.stop', () => { })
            .on('mousedown.stop', () => { });
        this.el = (0, element_1.h)('div', `${config_1.cssPrefix}-editor`)
