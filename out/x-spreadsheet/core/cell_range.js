...
class CellRange {
    ...
    includes(...args) {
        let [ri, ci] = [0, 0];
        if (args.length === 1) {
            [ci, ri] = (0, alphabet_1.expr2xy)(args[0]);
        }
    ...
    toString() {
        const { sri, sci, eri, eci, } = this;
        let ref = (0, alphabet_1.xy2expr)(sci, sri);
        if (this.multiple()) {
            ref = `${ref}:${(0, alphabet_1.xy2expr)(eci, eri)}`;
        }
        return ref;
    }
    clone() {
    ...
    */
    ...
    static valueOf(ref) {
        ...
        const [sci, sri] = (0, alphabet_1.expr2xy)(refs[0]);
        let [eri, eci] = [sri, sci];
        if (refs.length > 1) {
            [eci, eri] = (0, alphabet_1.expr2xy)(refs[1]);
        }
...
//# sourceMappingURL=cell_range.js.map