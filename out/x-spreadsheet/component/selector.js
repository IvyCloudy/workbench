...
const cell_range_1 = require("../core/cell_range");
...
class SelectorElement {
    constructor(useHideInput = false, autoFocus = true) {
        ...
        this.inputChange = () => { };
        this.cornerEl = (0, element_1.h)('div', `${config_1.cssPrefix}-selector-corner`);
        this.areaEl = (0, element_1.h)('div', `${config_1.cssPrefix}-selector-area`)
            .child(this.cornerEl).hide();
        this.clipboardEl = (0, element_1.h)('div', `${config_1.cssPrefix}-selector-clipboard`).hide();
        this.autofillEl = (0, element_1.h)('div', `${config_1.cssPrefix}-selector-autofill`).hide();
        this.el = (0, element_1.h)('div', `${config_1.cssPrefix}-selector`)
            .css('z-index', `${startZIndex}`)
            .children(this.areaEl, this.clipboardEl, this.autofillEl)
            .hide();
        if (useHideInput) {
            this.hideInput = (0, element_1.h)('input', '')
                .on('compositionend', (evt) => {
                this.inputChange(evt.target.value);
            });
            this.el.child(this.hideInputDiv = (0, element_1.h)('div', 'hide-input').child(this.hideInput));
            this.el.child(this.hideInputDiv = (0, element_1.h)('div', 'hide-input').child(this.hideInput));
        }
        startZIndex += 1;
    }
...
class Selector {
    constructor(data) {
        ...
        this.range = null;
        this.arange = null;
        this.el = (0, element_1.h)('div', `${config_1.cssPrefix}-selectors`)
    ...
    showAutofill(ri, ci) {
        ...
        if (scn > 0) {
            // left
            // console.log('left');
            this.arange = new cell_range_1.CellRange(sri, nci, eri, sci - 1);
            ...
            // console.log('top');
            // nri = sri;
            this.arange = new cell_range_1.CellRange(nri, sci, sri - 1, eci);
            ...
            // console.log('right');
            // nci = eci;
            this.arange = new cell_range_1.CellRange(sri, eci + 1, eri, nci);
            ...
            // console.log('bottom');
            // nri = eri;
            this.arange = new cell_range_1.CellRange(eri + 1, sci, nri, eci);
